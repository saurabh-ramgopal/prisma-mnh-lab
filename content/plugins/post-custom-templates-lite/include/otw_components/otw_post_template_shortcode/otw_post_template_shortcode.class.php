...
class OTW_Post_Template_Shortcode extends OTW_Component{
	...
	private function init_block_button(){
		...
		if( otw_init_filesystem() ){
			...
			if( $wp_filesystem->is_file( plugin_dir_path( __FILE__ ) . 'build/index.asset.php' ) ){
				...
				wp_register_script( 'otw-post-template-shortcode-block-editor', plugins_url( 'build/index.js', __FILE__ ), $asset_file['dependencies'], $asset_file['version'] );
				
				if( function_exists( 'register_block_type' ) ){
					if( !WP_Block_Type_Registry::get_instance()->is_registered( 'otw-post-template-shortcode-component/otw-post-template-shortcode-block' ) ){
						register_block_type( 'otw-post-template-shortcode-component/otw-post-template-shortcode-block', array( 'editor_script' => 'otw-post-template-shortcode-block-editor' ) );
					}
				}
			}
		}
	...
	public function load_admin_js(){
		...
		$js .= "otw_post_template_shortcode_component = new otw_post_template_shortcode_object();";
